...
function myButtonClicked() {
  ...
  // output
  document.getElementById('grossPay').innerHTML = `Your pay will be: $ ${grossPay.toFixed(2)}`
  document.getElementById('deductions').innerHTML = `The governement will take: $ ${deductions.toFixed(2)}`
  document.getElementById('afterDeductions').innerHTML = `Your pay after deductions is: $ ${afterDeductions.toFixed(2)}`
}
